...
class ControllerPaymentWirecardSkrillDirect extends ControllerPaymentWirecard {

	public $payment_type_prefix = '_skrilldirect';
	public $payment_type = WirecardCEE_QPay_PaymentType::SKRILLDIRECT;
