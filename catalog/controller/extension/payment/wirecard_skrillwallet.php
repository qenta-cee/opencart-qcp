...
class ControllerExtensionPaymentWirecardSkrillWallet extends ControllerExtensionPaymentWirecard
{
    public $payment_type_prefix = '_skrillwallet';
    public $payment_type = WirecardCEE_QPay_PaymentType::SKRILLWALLET;
}
