...
class ControllerExtensionPaymentWirecardGiropay extends ControllerExtensionPaymentWirecard
{
    public $payment_type_prefix = '_giropay';
    public $payment_type = WirecardCEE_QPay_PaymentType::GIROPAY;
}
