...
class ControllerExtensionPaymentWirecardCreditcard extends ControllerExtensionPaymentWirecard
{
    private $error = array();

    // define payment type
    public $payment_type_prefix = '_creditcard';

    public $payment_type = WirecardCEE_QPay_PaymentType::CCARD;
}
