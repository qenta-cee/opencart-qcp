...
class ControllerExtensionPaymentWirecardEkonto extends ControllerExtensionPaymentWirecard
{
    public $payment_type_prefix = '_ekonto';
    public $payment_type = WirecardCEE_QPay_PaymentType::EKONTO;
}
