...
class ControllerExtensionPaymentWirecardQuick extends ControllerExtensionPaymentWirecard
{
    public $payment_type_prefix = '_quick';
    public $payment_type = WirecardCEE_QPay_PaymentType::QUICK;
}
