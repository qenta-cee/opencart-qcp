...
$_['text_success'] = 'You have successfully modified the QENTA account details';
...
$_['license_text'] = "<h1>Terms of use	</h1> This terms of use regulates warranty and liability between QENTA Payment CEE(subsequently referred to as QENTA) and it's	 contractual partners (subsequently referred to as customer or customers) which are related to the use of plugins provided by QENTA.	 The Plugin is provided by QENTA free of charge for it's customers and must be used for the purpose of QENTA's payment platform	 integration only. It explicitly is not part of the general contract between QENTA and it's customer. The plugin has successfully been tested	 under specific circumstances which are defined as the shopsystem's standard configuration (vendor's delivery state). The Customer is	 responsible for testing the plugin's functionality before putting it into production enviroment.	 The customer uses the plugin at own risk. QENTA does not guarantee it's full functionality neither does QENTA assume liability for any	 disadvantage related to the use of this plugin. By installing the plugin into the shopsystem the customer agrees to the terms of use.	 Please do not use this plugin if you do not agree to the terms of use!";
...
$_['customerId_descript'] = 'The  &quot;Customer ID &quot; you received from QENTA ';
$_['secret_descript'] = 'The  &quot;Secrect&quot; you received from QENTA';
...
$_['shopId_descript'] = 'Your “Shop ID“ you revceived from QENTA';
